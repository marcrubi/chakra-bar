...
export default function Hero() {
    return (
        <section className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center text-center px-4">
            {/* Fondo atmosférico con luces rojas */}
            ...
            <div className="relative z-10 max-w-4xl mx-auto space-y-8">
                ...
                >
                    {/* Subtítulo */}
                    <p className="text-accent text-xs md:text-sm tracking-[0.3em] uppercase font-sans font-semibold text-glow-gold">
                        Est. 2025
                    </p>
                ...
                >
                    <Link
                        href="/carta"
                        className="group relative overflow-hidden px-10 py-4 bg-black/40 backdrop-blur-sm border border-primary/40 text-foreground font-sans tracking-widest uppercase text-xs transition-all duration-500 inline-flex items-center justify-center gap-2 hover:border-ruby/50"
                    >
            <span className="relative z-10 group-hover:text-white transition-colors duration-300">
              Ver Carta
            </span>
                        <span className="absolute inset-0 bg-primary/60 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out" />
                    </Link>
                </motion.div>
            </div>
